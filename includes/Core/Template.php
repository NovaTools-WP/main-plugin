 ...
 * Class Template
 *
 * Represents the Template class for NovaTools.
 *
...
class Template {
	...
	const FRONTEND_TEMPLATE_NAME = 'NovaTools';
	const FRONTEND_TEMPLATE_SLUG = 'novatools';
	...
	public function load_custom_template( $template ) {
		if ( get_page_template_slug() === self::FRONTEND_TEMPLATE ) {
			$template_file_dir = NOVATOOLS_DIR . 'views/templates/' . self::FRONTEND_TEMPLATE;
