#!/usr/bin/env bash
#
# Build a production-ready ZIP of NovaTools main plugin.
...
with zipfile.ZipFile(zip_path, "w", zipfile.ZIP_DEFLATED) as zf:
    for root, dirs, files in os.walk(plugin_dir):
        ...
        for f in files:
            ...
            if should_skip(rel):
                continue
            arcname = prefix + rel          # novatools/includes/...
